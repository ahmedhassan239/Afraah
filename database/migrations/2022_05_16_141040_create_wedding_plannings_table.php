...
class CreateWeddingPlanningsTable extends Migration {
	...
	public function up()
	{
		Schema::create('wedding_plannings', function(Blueprint $table)
		{
			$table->bigInteger('id', true)->unsigned();
			$table->string('name')->nullable();
			$table->string('slug')->nullable();
			$table->text('phone')->nullable();
			$table->string('email')->nullable()->unique('wedding_planning_email_unique');
