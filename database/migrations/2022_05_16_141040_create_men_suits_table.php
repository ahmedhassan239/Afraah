...
class CreateMenSuitsTable extends Migration {
	...
	public function up()
	{
		Schema::create('men_suits', function(Blueprint $table)
		{
			...
			$table->text('atelier_name')->nullable();
			$table->text('atelier_location')->nullable();
			$table->text('atelier_number')->nullable();
			$table->text('atelier_email')->nullable();
