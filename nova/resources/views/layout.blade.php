...
<div id="nova">
    <div v-cloak class="flex min-h-screen">
        <!-- Sidebar -->
        <div class="min-h-screen flex-none pt-header min-h-screen w-sidebar bg-grad-sidebar px-6" style="width:250px; ">
            ...
            @foreach (\Laravel\Nova\Nova::availableTools(request()) as $tool)
               <strong>{!! $tool->renderNavigation() !!}</strong>
        ...
        <div class="content">
            ...
            <div data-testid="content" class="px-view py-view mx-auto">
                ...
                <p class="mt-8 text-center text-xs text-80">
                    ...
                    <a href="https://www.digitalexperts.ae" class="text-primary dim no-underline">Digital Experts</a>
                {{ date('Y') }}
            </div>
        </div>
    </div>
