...
class MakeupArtist extends Model
{
    ...
    public $translatable =[
        'name','slug','description','phone','package','gallery','og_title',
        'banner','alt','thumb','thumb_alt','seo_title','seo_keywords','seo_robots','seo_description',
        'facebook_description','facebook_image','twitter_title','twitter_description','twitter_image','category_slug',
        'service_name','category_name','city_name','country_name','service_seo_title','service_seo_keywords','services_seo_robots','services_seo_description','services_facebook_description',
    ...
    {
        return $this->hasMany(\App\Models\like\MakeupArtist::class,'article_id');
    }
