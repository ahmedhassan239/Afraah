...
class Motorcycle extends Model
{
    ...
    protected $fillable = [
        'name','description','code','style','city_id','category_id','gallery','car_rental_showroom_name',
    ...
    public $translatable =[
        'name','slug','style','description','phone','gallery','car_rental_showroom_name',
        'car_rental_showroom_location','og_title',
        'banner','alt','thumb','thumb_alt','seo_title','seo_keywords','seo_robots','seo_description',
    ...
    {
        return $this->hasMany(\App\Models\like\Motorcycle::class,'article_id');
    }
