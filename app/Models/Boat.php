...
class Boat extends Model
{
    ...
    public $translatable =[
        'name','slug','description','phone','package','package','gallery','og_title',
        'banner','alt','thumb','thumb_alt','seo_title','seo_keywords','seo_robots','seo_description',
        ...
        'service_seo_title','service_seo_keywords','services_seo_description','services_facebook_description','service_banner_alt',
        'services_facebook_image','services_twitter_title','services_twitter_description','services_twitter_image','category_slug','services_seo_robots',
    ...
    {
        return $this->hasMany(\App\Models\like\Boat::class,'article_id');
    }
