...
class Limousine extends Model
{
    use HasFactory;
    use HasTranslations;
    public $table = "limousine";

    protected $fillable = [
        'name','description','code','style','city_id','category_id','country_id','gallery','car_rental_showroom_name',
    ...
    {
        return $this->hasMany(\App\Models\like\Limousine::class,'article_id');
    }
