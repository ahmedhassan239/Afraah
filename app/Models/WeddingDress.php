...
class WeddingDress extends Model
{
    ...
    protected $fillable = [
        'name','description','code','style','city_id','category_id','gallery',
    ...
    public $translatable =[
        'name','slug','style','description','phone','gallery','atelier_name','atelier_location','atelier_email',
        'atelier_number','og_title',
        'banner','alt','thumb','thumb_alt','seo_title','seo_keywords','seo_robots','seo_description',
    ...
    {
        return $this->hasMany(\App\Models\like\WeddingDress::class,'article_id');
    }
