...
{
    use HasFactory;
    public $table = "wedding_plannings";
    use HasTranslations;

    protected $fillable = [
        'name','email','slug','description','phone','package','package','city_id','category_id','gallery',
    ...
    {
        return $this->hasMany(\App\Models\like\WeddingPlanning::class,'article_id');
    }
