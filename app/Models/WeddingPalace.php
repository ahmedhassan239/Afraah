...
class WeddingPalace extends Model
{
    ...
    public $translatable =[
        ...
        'services_facebook_image','services_twitter_title','services_twitter_description','services_twitter_image','category_slug','category_slug'
    ];
    ...
    {
        return $this->hasMany(\App\Models\like\WeddingPalace::class,'article_id');
    }
