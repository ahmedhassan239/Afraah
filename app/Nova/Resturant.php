...
class Resturant extends Resource
{
    ...
    public static $model = \App\Models\Resturant::class;
    ...
    {
        return '<img style="margin-right: .75rem;width: 20px;height: 20px;transform: translateY(3px);"  src="/icons/Restaurant.png" />';
    }
