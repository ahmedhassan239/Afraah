...
class HoneyMoon extends Resource
{
    use TabsOnEdit;
     ...
     * @var string
     */
    public static $model = \App\Models\HoneyMoon::class;
    ...
    {
        return '<img style="margin-right: .75rem;width: 20px;height: 20px;transform: translateY(3px);"  src="/icons/honey_moon.png" />';
    }

    public static $group  = '<span class="hidden">6</span>Wedding Planning';
