...
class Dj extends Resource
{
     ...
     * @var string
     */
    public static $model = \App\Models\Dj::class;
    ...
    {
        return '<img style="margin-right: .75rem;width: 20px;height: 20px;transform: translateY(3px);"  src="/icons/Dj.png" />';
    }
