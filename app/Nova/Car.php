...
class Car extends Resource
{
    ...
    {
        return '<img style="margin-right: .75rem;width: 20px;height: 20px;transform: translateY(3px);"  src="/icons/Car.png" />';
    }
            ...
            new Tabs(
                ...
                [
                    'Basic Information' => array(
                        ...
                        Number::make('Price Starting From' , 'price'),
                        Text::make('Code'),
                    ...
                    'Contact' => [
                        NovaTabTranslatable::make([
                            ...
                            Text::make('Car Rental showroom Location')->hideFromIndex(),
                        ]),
