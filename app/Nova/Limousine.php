...
class Limousine extends Resource
{
    use TabsOnEdit;
     ...
     * @var string
     */
    public static $model = \App\Models\Limousine::class;
    ...
    public static $group  = '<span class="hidden">9</span>Car Rental';
    public static function icon()
    {
        return '<img style="margin-right: .75rem;width: 20px;height: 20px;transform: translateY(3px);"  src="/icons/Limousine.png" />';
    }
        ...
        return [
            ...
            new Tabs(
                ...
                [
                    ...
                    'Contact' => [
                        NovaTabTranslatable::make([
                            Text::make('Car Rental showroom Name')->hideFromIndex(),
                            CKEditor::make('Car Rental showroom Location')->hideFromIndex(),
                        ]),
                        Text::make('Car Rental showroom Email')->hideFromIndex(),
                        Number::make('Car Rental showroom Number')->hideFromIndex(),
