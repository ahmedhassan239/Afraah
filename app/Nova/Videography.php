...
class Videography extends Resource
{
    use TabsOnEdit;
     ...
     * @var string
     */
    public static $model = \App\Models\Videography::class;
    ...
    public static $group  = '<span class="hidden">8</span>Media';
    public static function icon()
    {
        return '<img style="margin-right: .75rem;width: 20px;height: 20px;transform: translateY(3px);"  src="/icons/Videography.png" />';
    }
                    ...
                    'Basic Information' => array(
                        ...
                        'Packages' => [
                            ...
                            ->addLayout('Package', 'wysiwyg', [
                                Translatable::make('Package Name'),
                                FilemanagerField::make('Package Image')->hideFromIndex(),
                                Translatable::make('Description')->trix()->hideFromIndex(),
                                Number::make('Package Price')
