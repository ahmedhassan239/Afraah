...
class WeddingCake extends Resource
{
    use TabsOnEdit;
     ...
     * @var string
     */
    public static $model = \App\Models\WeddingCake::class;
    ...
    public static $group  = '<span class="hidden">7</span>Catering';
    /**
    ...
    {
        return '<img style="margin-right: .75rem;width: 20px;height: 20px;transform: translateY(3px);"  src="/icons/wedding_cakes.png" />';
    }
