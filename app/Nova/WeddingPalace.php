...
class WeddingPalace extends Resource
{
    use TabsOnEdit;
     ...
     * @var string
     */
    public static $model = \App\Models\WeddingPalace::class;
...
//    public static $group = '<span class="hidden">20</span>Wedding Halls';
    public static function icon()
    {
        return '<img style="margin-right: .75rem;width: 20px;height: 20px;transform: translateY(3px);"  src="/icons/WeddingPalace.png" />';
    }
