...
class HairDresser extends Resource
{
    use TabsOnEdit;
     ...
     * @var string
     */
    public static $model = \App\Models\HairDresser::class;
    ...
    {
        return '<img style="margin-right: .75rem;width: 20px;height: 20px;transform: translateY(3px);"  src="/icons/HairDresser.png" />';
    }
